...
# Load data
HAPVIDA = st.session_state['HAPVIDA']

# Unique values for filters
cidades = ['Todos'] + list(HAPVIDA['CIDADE'].unique())
estados = ['Todos'] + list(HAPVIDA['UF'].unique())
status_options = ['Todos'] + list(HAPVIDA['STATUS'].unique())
...
fig_top_estados = px.bar(ocorrencias_por_estado, x='UF', y='Quantidade',
                          ...
                          labels={'Quantidade': 'Quantidade de Reclamações', 'EUF': 'UF'},
                          text='Quantidade')
